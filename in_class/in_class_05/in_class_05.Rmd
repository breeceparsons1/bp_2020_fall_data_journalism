...
# A: District of Columbia with 13959 and Arizona with 13446.33
```
...
#A: New Jersey with 758.9 average county deaths 
...
least_averages_county_deaths_by_state <- covid_county %>%
  group_by(state) %>%
  summarise(average_county_deaths = mean(deaths)) %>%
  arrange(average_county_deaths)

# Display below
least_averages_county_deaths_by_state

#A: Alaska with 1.31 average county deaths 
```
