...
-30-
```{r}
covid_florida_july_aug_pct_change <- covid_county_monthly_case_rate %>%
  select(county, state, d_2020_06_30, d_2020_08_30) %>%
  filter(state == "Florida") %>%
  mutate(jul_aug_pct_change = (d_2020_08_30 - d_2020_06_30)/d_2020_06_30*100) %>%
  arrange(jul_aug_pct_change)
