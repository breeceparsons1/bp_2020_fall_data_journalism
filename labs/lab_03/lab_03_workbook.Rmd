...
# A: Two areas including Hancock and Galax City 
...
```{r}
# Question: Which county in Georgia had the largest percentage change in cumulative death rate between June and July?
covid_county_jun_jul_pct_change <- covid_county_monthly_death_rate %>%
